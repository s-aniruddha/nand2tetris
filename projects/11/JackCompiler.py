...
class CompilationEngine:
    ...
    def CompileClassVarDec(self):
        ...
        if (tokenizer.tokenType() == SYMBOL and tokenizer.symbol() == '}'):
            ...
            return
        if (tokenizer.keyWord() == CONSTRUCTOR or tokenizer.keyWord() == FUNCTION or tokenizer.keyWord() == METHOD):
            tokenizer.goBack()
            return    
    ...
    def compileLet(self):
        ...
        if self.tokenizer.tokenString() == '[':
            isArray = True
            self.writer.writePush(self.symbolTable.getSegment(varName), self.symbolTable.IndexOf(varName))
        ...
        if isArray:
            ...
            self.writer.writePop(self.symbolTable.getSegment(varName), self.symbolTable.IndexOf(varName))
    ...
    def compileSubroutineCall(self):
        ...
        if (self.tokenizer.tokenType() == SYMBOL and self.tokenizer.symbol() == '('):
            ...
            if (typ == ""):
                ...
                nArgs = 1
                self.writer.writePush(self.symbolTable.getSegment(objName), self.symbolTable.IndexOf(objName))
    ...
    def compileTerm(self):
        ...
        if (self.tokenizer.tokenType() == IDENTIFIER):
            ...
            elif(self.tokenizer.tokenType() == KEYWORD and (self.tokenizer.keyWord() == FALSE or self.tokenizer.keyWord() == NULL)):
                self.writer.writePush(CONST,0)
